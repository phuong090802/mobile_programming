...
public class MyService extends Service {
    ...
    private void sendNotification(Song song) {
        ...
        remoteViews.setOnClickPendingIntent(R.id.ivPrevious, sendDataToReceiver(this, MyUtilities.previousSong(songList, globalSong)));
        remoteViews.setOnClickPendingIntent(R.id.ivNext, sendDataToReceiver(this, MyUtilities.nextSong(songList, globalSong)));
        remoteViews.setImageViewResource(R.id.ivPlayPause, R.drawable.md_pause);
    ...
    private PendingIntent sendDataToReceiver(Context context, Song song) {
        ...
        intent.putExtra("song", song);
        intent.putExtra("isPlaying", true);
        return PendingIntent.getBroadcast(context.getApplicationContext(), Constant.REQUEST_CODE, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_IMMUTABLE);
    }
